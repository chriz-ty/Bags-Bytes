...
import { Menu, X, ShoppingBag, Binary } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = [
    { name: 'Home', path: '/' },
    { name: 'Tech Services', path: '/tech-services' },
    { name: 'Merchandise', path: '/merchandise' },
    { name: 'Event Branding', path: '/event-branding' },
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <Binary className="h-8 w-8 text-emerald-600" />
              <span className="font-bold text-xl text-gray-800">Bags & Bytes</span>
            </Link>
          </div>
